...
public class EditNavigator implements BaseActivityLifeCycle {
    ...
    public EditNavigator(Activity activity) {
    ...
    private void fragmentTransactionReplace(Fragment fragment) {
        ...
        fragmentTransaction.replace(R.id.activity_edit_fragment_container, fragment, fragment.getClass().getName());
        fragmentTransaction.commit();
    }

    private void fragmentTransactionAdd(Fragment fragment) {
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.add(R.id.activity_edit_fragment_container, fragment, fragment.getClass().getName());
